...
// Цей цикл спершу виконує а потім перевіряє условіє він виконується хотя би один раз.
do{
    console.log(num);
    num++;
}
...
//Функції це наші дії в JS вони використовують всі типи даних і змінюють їх так як ми їх вкажемо це як калькулятор вводимо дані і получаємо результат.
